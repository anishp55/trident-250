...
git pull -v "https://Imburr:$mygittoken@github.com/Imburr/klipper_config.git"
# https://Imburr:$mygittoken@github.com/Imburr/klipper_config.git
git add . -v
current_date=$(date +"%Y-%m-%d %T")
git commit -m "Backup triggered on $current_date" "${gitrevs[@]}"
git push "https://Imburr:$mygittoken@github.com/Imburr/klipper_config.git"